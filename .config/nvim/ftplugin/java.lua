...
local config = {
  ...
  settings = {
    java = {
      ...
      home = "/Users/inotekk/Library/Java/JavaVirtualMachines/openjdk-23.0.1/Contents/Home",
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-21",
            path = "/Users/inotekk/Library/Java/JavaVirtualMachines/openjdk-21.0.2/Contents/Home",
          },
          {
            name = "JavaSE-23",
            path = "/Users/inotekk/Library/Java/JavaVirtualMachines/openjdk-23.0.1/Contents/Home",
          },
        },
      },
      maven = {
